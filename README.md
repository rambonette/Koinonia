...
## Additional Taglines You Could Use:

- "Shop together, finish faster"
- "Parallel shopping, synchronized lists"
- "Fellowship in efficiency"
- "Your household, your network"
- "Split the aisles, not the list"

## F-Droid Specific Description:

For the F-Droid metadata:
```
Koinonia enables parallel grocery shopping with real-time P2P synchronization. 
Multiple people can shop the same list simultaneously - as items are found and 
checked off, everyone sees updates instantly. No central server, no accounts, 
no tracking. Share lists via deep links and shop efficiently as a team.

Features:
* Real-time peer-to-peer sync (WebRTC + Yjs CRDT)
* Works offline, syncs when reconnected
* No server required - your data stays on your devices
* Share lists via simple deep links
* Perfect for households shopping in parallel
